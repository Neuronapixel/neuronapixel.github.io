  ...
  <div class="xr-experience">
    <section class="viewport desktop">
      ...
      >
        <a-assets>
          <a-mixin
            id="primary-material"
            material="color: #ff2f2f; metalness: 0.05; roughness: 0.4"
          />
          <a-mixin
            id="secondary-material"
            material="color: #ffffff; roughness: 0.4; emissive: #ffffff; emissiveIntensity: 0.4"
          />
          <a-mixin
            id="cube"
        ...
        <a-entity
          light="type: directional; intensity: 0.75"
          position="-1.5 3 2"
        />
        <a-entity
    ...
    <section>
      <div class="info">
        <h2>Neuronapixel</h2>
        <p>
          Web development, scripting, coding, creativity; multimedia as a
          language of countless interpretations in which each experience is a
          different message
        </p>
        <p>
          Neuronapixel believes in the intrinsic value of interaction as a
          vehicle for the transit of ideas.
        </p>
      </div>
    </section>
  </div>
